...
-- Tiempo de generación: 27-09-2025 a las 22:33:42
...
CREATE TABLE `pagos` (
  ...
  `estado_pago` enum('pagado','pendiente','rechazado') DEFAULT 'pendiente'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `apellido`, `correo`, `contraseña`, `rol`, `direccion`, `telefono`, `fecha_registro`) VALUES
(1, 'cristhian', 'garay', 'ati76434193@istrfa.edu.pe', 'e10adc3949ba59abbe56e057f20f883e', 'cliente', 'enrique segoviano', '987654321', '2025-09-27 20:15:11');
...
--
ALTER TABLE `carritodetalle`
  ADD CONSTRAINT `carritodetalle_ibfk_1` FOREIGN KEY (`id_carrito`) REFERENCES `carrito` (`id_carrito`),
  ADD CONSTRAINT `carritodetalle_ibfk_2` FOREIGN KEY (`id_producto`) REFERENCES `productos` (`id_producto`);
...
--
ALTER TABLE `reembolsos`
  ADD CONSTRAINT `reembolsos_ibfk_1` FOREIGN KEY (`id_pedido`) REFERENCES `pedidos` (`id_pedido`);
COMMIT;
